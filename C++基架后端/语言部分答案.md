 ...
 * @LastEditTime: 2023-08-07 23:20:27
...
25. dfs和bfs的区别；一棵瘦高的树用dfs还是bfs
26. LRU怎么实现
27. 内存2g 磁盘500g 文件大小20g 每行一个数字 怎么对文件排序
28. 悲观锁和乐观锁
29. 类加载过程
30. static关键字的用处是什么？
31. include<>和include“”的区别是什么
32. const关键字的使用；`const int *p，int * const p`等组合的区别
33. 动态链接静态链接区别是什么？